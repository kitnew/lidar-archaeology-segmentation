...
\chapter{Supplementary Material}\label{app:suplementary.material}
...
& LiDAR-derived input
& \gls{dem} (raw); RGB; RGDEM (raw); RGDEM (z-score); \gls{sps} (z-score)
& 10
& \gls{sps} (z-score)
...
\caption{Overview of conducted experiments on Maya and Slovakia datasets with outcomes.}
