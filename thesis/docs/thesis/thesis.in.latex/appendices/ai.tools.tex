...
This appendix provides a transparent overview of the artificial intelligence and AI-assisted tools that were used during the preparation of this thesis. The purpose of this appendix is not to present these tools as part of the proposed methodological contribution, but to clearly distinguish between the author's own work and external AI-assisted support used during literature search, workflow design, implementation support, debugging, and text refinement.

The use of AI-assisted tools was limited to supportive, consultative, and organizational tasks. These tools were not used as autonomous decision-making systems and did not replace the author's responsibility for the research design, implementation, experimental evaluation, interpretation of results, or final academic writing. All methodological choices, experimental decisions, code integration, result interpretation, and final text approval remained under the author's control.

\section{General Principles of Use}

AI-assisted tools were used according to the following principles:

\begin{itemize}
    \item AI tools were used as auxiliary instruments for literature discovery, note enrichment, workflow consultation, code assistance, debugging, and language refinement.
    ...
    \item AI-assisted textual edits were used for improving clarity, grammar, structure, and consistency, while the final meaning, argumentation, and responsibility for the text remained with the author.
...
Anara was used only for the initial analysis of the root article by Bundzel et al., which served as one of the main starting points for understanding the domain-specific background of LiDAR-based archaeological segmentation. Its use was limited to early familiarization with the article and did not replace the author's own reading, interpretation, or subsequent analysis of the publication.
...
The use of AI-assisted tools did not include the following:
...
The final thesis therefore remains the author's own academic work. AI-assisted tools were used only as supporting instruments for literature exploration, workflow organization, implementation assistance, debugging, language refinement, and critical discussion of results.