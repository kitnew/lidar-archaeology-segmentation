...
Small  & 1430 & 45366.0 & 35.01 & 0.0271 \\
Medium & 2182 & 212186.0 & 53.43 & 0.1268 \\
Large  & 472  & 194331.0 & 11.56 & 0.1161 \\ \hline
All    & 4084 \\
\end{tabular}
...
\begin{tabular}{lrrr}
\hline
Region & Count & Total area (m\textsuperscript{2}) & Map area (\%) \\ \hline
Sitno       & 142 & 231159.0 & 1.0395 \\
Sásovské    &  91 & 187406.0 & 2.1055 \\
Ladzany     &  24 &  51903.0 & 0.3313 \\ \hline
All         & 257 \\
\end{tabular}
\caption{Distribution of Slovak archaeological structures by size category and their coverage within the mapped area.}
\label{tab:slovak_structures_size}
\end{table}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/maya_confidence_shadow_example.png}
	\caption{Example of a \textit{confidence shadow} for a Maya archaeological structure. The original boundary is shown in yellow, while the confidence shadow gradually decreases in intensity from 1 to 0 within a defined neighbourhood around the object to purple.}
...
\begin{figure}[h!]
	...
	\caption{Overview on how buffered (b) masks distinguish from raw (a) rasterized polylines in width and shape for the terrace structures in Slovak dataset.}
...
\begin{figure}[h!]
    ...
    \caption{Example of input representations for the Maya dataset. From left to right: DEM (a), Hillshade (b), RGB visualization (c).}
...
\begin{figure}[h!]
    ...
    \caption{Example of input representations for the Slovak dataset. From left to right: DEM (a), Hillshade (b), ISO visualization (c), ANISO visualization (d).}
